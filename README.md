...
- "Optionally with no gameplay changes"?
  ...
  Also, some gameplay changes are the result of bugs in the original game, but if you feel that these bugs should stay, you can use the COMP command-line parameter to re-enable them! -- See the [tips section](#dont-hurt-midi) for more details.
